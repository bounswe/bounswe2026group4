...
function FeedPage() {
  const { q, yearFrom, yearTo, location, tags, page, sortBy, hasActiveFilters, setFilters } =
    useFilterState();
  ...
  const fetchStories = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await getStories({ q, yearFrom, yearTo, location, tags, page, pageSize: PAGE_SIZE, sortBy });
  ...
  }, [q, yearFrom, yearTo, location, tags, page, sortBy]);
