...
class UsersConfig(AppConfig):
    ...
    def _warn_if_email_misconfigured(self):
        ...
        # like Mailpit/MailHog can accept SMTP with no authentication. These
        # warnings are only meaningful for production deployments.
        if not getattr(settings, 'DEBUG', False):
            ...
            # Catch both example.com and .example placeholders.
    ...
    def _warn_if_frontend_url_misconfigured(self):
        ...
        if not frontend_url or 'localhost' in frontend_url or '127.0.0.1' in frontend_url:
            logger.warning(
                ...
                'Set FRONTEND_URL to your deployed frontend URL in .env.',
                frontend_url,
            )